...
public class SecurityConfig {
    ...
    public UserDetailsManager userDetailsManager(){
        return new InMemoryUserDetailsManager(
                User.withUsername("imane").password(passwordEncoder.encode("1234")).authorities("USER").build(),
                User.withUsername("hajar").password(passwordEncoder.encode("1234")).authorities("USER").build(),
                User.withUsername("hamza").password(passwordEncoder.encode("1234")).authorities("ADMIN").build()
        );
    }
